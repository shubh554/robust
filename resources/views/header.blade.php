...
<!-- Mirrored from wphix.com/template/dukamarket/dukamarket/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 09:16:25 GMT -->
<head>
      <meta charset="utf-8">
      <meta http-equiv="x-ua-compatible" content="ie=edge">
      <title>Robust Promotions</title>
   ...
   <body>
    ...
    <!-- preloader end -->
     ...
     <!-- header-start -->
     <header class="header d-blue-bg"  style="position:fixed;z-index:10000000000;width:100%;top:0">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="index-2.html" class="logo-image"><img src="{{url('assets/img/logo/logo1.svg')}}" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="cat-toggle">
                                ...
                                <div class="cat__menu">
                                    <nav id="mobile-menu" style="display: block;">
                                        ...
                                        <li>
                                                <a href="shop.html">{{$row->category_name}} <i class="far fa-angle-down"></i></a>
                                                <ul class="submenu">
                                                    <li style="color:red;text-align:center;">Sub-Categories</li>
                                                    <hr>
                                                    @foreach($sub_categories as $row2)
                                                    @if($row->id != $row2->category_id)
                                                    @continue
                                                    @endif
                                                    <li><a href="shop.html">{{$row2->sub_category}}</a></li>
                                                    @endforeach
                                                </ul>
                                            </li>
                                            @endforeach
    ...
    <div class="main-menu">
        <nav id="mobile-menu-2">
            <ul>
                <li>
                    <a href="index-2.html" class="active">Home <i class="far fa-angle-down"></i></a>
                    <ul class="megamenu-1">
                        <li><a href="index-2.html">Home Pages</a>
                            <ul class="mega-item">
...
<!-- Mirrored from wphix.com/template/dukamarket/dukamarket/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Nov 2023 09:16:37 GMT -->
</html>